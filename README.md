...
A research project focused on developing a domain-specific Small Language Model (SLM) for healthcare using fine-tuning and Retrieval-Augmented Generation (RAG).
